...
export default function AboutScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="About SPORS" onBackPress={() => router.back()} rightIcon="info" />
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.logoSection}>
          ...
          <Text style={styles.appName}>SPORS</Text>
          <Text style={styles.appSubtitle}>Secure Phone Ownership & Recovery System</Text>
          <Text style={styles.version}>Version 1.0.0</Text>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>What is SPORS?</Text>
          <Text style={styles.sectionText}>
            SPORS is a Bluetooth-based lost device tracking application designed to help users 
            register, protect, and recover their personal devices. Using BLE (Bluetooth Low Energy) 
            technology, SPORS creates a community-powered network for device recovery.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionText}>
            ...
            3. Other SPORS users scan for nearby lost devices{'\n'}
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.copyright}>© 2024 SPORS. All rights reserved.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  )
