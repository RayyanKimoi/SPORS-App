  ...
  return (
    <div style={containerStyle}>
      <header style={headerStyle}>
        ...
        <h1 style={titleStyle}>About SPORS</h1>
      </header>
      ...
      <Card style={{ textAlign: 'center', marginBottom: '24px' }}>
        <div style={logoStyle}>
          ...
          <span style={{ fontSize: '32px', fontWeight: 700, color: Colors.primary }}>SPORS</span>
        </div>
      ...
      <Card style={sectionStyle}>
        ...
        <p style={textStyle}>
          SPORS is a comprehensive device protection and recovery system that uses Bluetooth Low
      ...
      <Card style={sectionStyle}>
        ...
        <ol style={listStyle}>
          ...
          <li>Other SPORS users' phones passively scan for your device</li>
      ...
      <Card style={sectionStyle}>
        ...
        <p style={textStyle}>
          ...
          please use the SPORS mobile app.
        </p>
      </Card>
